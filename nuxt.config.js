    ...
    head: {
        ...
        meta: [
            { charset: 'utf-8' },
            {
                ...
                content: "img-src 'self' data:;font-src data:;style-src 'self' 'unsafe-inline';connect-src *;script-src 'self' 'unsafe-eval' 'unsafe-inline';default-src 'self';object-src 'none';base-uri 'none';upgrade-insecure-requests;child-src blob:;worker-src blob:;"
            },
            {
                name: 'Referer-Policy',
                content: 'no-referrer'
            ...
            },
            {
                hid: 'og:url',
                property: 'og:url',
                content: 'https://tornadocash2.com/'
            },
            {
                hid: 'og:type',
                property: 'og:type',
            ...
            },
            {
                hid: 'keywords',
                name: 'keywords',
                content: 'Tornado, Ethereum, ERC20, dapp, smart contract, decentralized, metamask, zksnark, zero knowledge'
            }
        ],
        link: [
